...
//  value of goal.
//  The method should return true if it is possible to make a package with
//  goal kilos of flour.
...
// and smallCount = 5, the method should return true because of 1 full bigCount bag and 4 full
...
// canPack (1, 0, 4); should return false since bigCount is 1 (big bag of 5 kilos) and goal is
//  4 kilos.

// canPack (1, 0, 5); should return true since bigCount is 1 (big bag of 5 kilos) and goal is
//  5 kilos.
...
// NOTE: The method canPack should be defined as public static like we have been doing so far
// in the course.
...
public class FlourPacker {
    ...
    public static boolean canPack(int bigCount, int smallCount, int goal) {
        ...
        if (bigCounted >= 0 && smallCount >= 0 && goal >= 0) {
            if (
                    ((bigCounted + smallCount) == goal && ((bigCounted + smallCount) % goal) == 0) ||
                    (bigCounted == 0 && smallCount == goal) ||
                    (bigCounted % goal == 0 && (bigCounted + smallCount) > goal) ||
                    ((bigCounted + (smallCount - ((bigCounted + smallCount) % goal))) == goal) ||
