...
//
//        The second parameter should be named height of type double. This parameter represents
...
//
//        If all parameters are valid, the method needs to calculate the number of buckets and
//        return it.
//
//
//
...
public class PaintJob {
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        double bucketsNeeded = Math.ceil((areaToPaint / areaPerBucket) - extraBuckets);
...
//    The PaintJob class contains three overloaded methods named getBucketCount that
//    take different combinations of parameters to calculate the number of paint buckets needed.
//
//        The first method takes four parameters: width, height, areaPerBucket, and extraBuckets.
//        It checks if any of the parameters are invalid, and if so, it returns -1. Otherwise,
//        it calculates the area to paint by multiplying the width and height parameters,
//        and then calculates the number of buckets needed by dividing the area to paint by the
//        areaPerBucket parameter, subtracting the extraBuckets parameter,
//        and rounding up to the nearest integer using the Math.ceil method.
//        The final result is cast to an int and returned.
//
//        The second method is an overloaded version of the first method that takes only three
//        parameters: width, height, and areaPerBucket.
//        It calls the first method with these parameters and an extraBuckets value of 0.
//
//        The third method is another overloaded version of the getBucketCount method that takes
//        two parameters: area and areaPerBucket. It checks if either parameter is invalid,
//        and if so, it returns -1. Otherwise, it calculates the number of buckets needed
//        by dividing the area parameter by the areaPerBucket parameter,
//        rounding up to the nearest integer using the Math.ceil method,
//        casting the result to an int, and returning it.
