...
//        (no-arg constructor). The second constructor has parameters x and y of type int and
...
//
//        Method named distance without any parameters, it needs to return the distance between this Point and
//        Point 0,0 as double.
//
