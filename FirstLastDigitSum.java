...
//
//        sumFirstAndLastDigit(-10); → should return -1, since the parameter is negative and needs
//        to be positive.
//
//
//
//        NOTE: The method sumFirstAndLastDigit needs to be defined as public static like
