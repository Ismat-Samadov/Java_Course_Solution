...
//        (where number is the number of rows to print). For each row or column, stars are printed based on
//        four conditions (Read them carefully):
//
...
//
//        NOTE: The method printSquareStar ​should be defined as public static like
