...
// rectangular rooms. To calculate the price, you multiply the area of the floor (width times length) by the price
// per square meter of carpet. For example, the area of the floor that is 12 meters long and 10 meters wide
// is 120 square meters. To cover the floor with a carpet that costs $8 per square meter would cost $960.
//
...
//
//        The class needs to have one constructor with parameters width and length of type double and it needs
...
//
//
//        2. Write a class with the name Carpet. The class needs one field (instance variable) with name
//        cost of type double.
//
...
//
//
//        3. Write a class with the name Calculator. The class needs two fields (instance variables) with
//        name floor of type Floor and carpet of type Carpet.
//
...
//        Write the following methods (instance methods):
//
//        Method named getTotalCost without any parameters, it needs to return the calculated total cost
